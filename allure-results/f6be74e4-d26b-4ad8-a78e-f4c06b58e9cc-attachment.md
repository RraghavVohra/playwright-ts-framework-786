...
- Name: push-notification.spec.ts >> TC_PN_13 - send to options are mutually exclusive
- Location: tests\e2e\push-notification.spec.ts:92:5
...
Call log:
  - waiting for locator('xpath=(//a/span[text()=\'Create App Notification\'])[1]') to be visible
    98 × locator resolved to hidden <span class="m-2">Create App Notification</span>

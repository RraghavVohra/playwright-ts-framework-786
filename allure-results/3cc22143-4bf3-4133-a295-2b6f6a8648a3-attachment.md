...
- Name: push-notification.spec.ts >> TC_PN_17 - missing category keeps form on create page
- Location: tests\e2e\push-notification.spec.ts:203:5
...
Call log:
  - waiting for locator('xpath=(//a/span[text()=\'Create App Notification\'])[1]') to be visible
    23 × locator resolved to hidden <span class="m-2">Create App Notification</span>

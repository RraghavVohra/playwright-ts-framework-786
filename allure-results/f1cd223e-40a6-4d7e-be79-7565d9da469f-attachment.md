...
- Name: banners.spec.ts >> TC_BNR_04 - creates a Banner using a .webp image and confirms it appears in the Asset Library
- Location: tests\e2e\banners.spec.ts:116:5

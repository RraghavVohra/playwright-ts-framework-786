...
- Name: push-notification.spec.ts >> TC_PN_23 - full form submission shows success toast
- Location: tests\e2e\push-notification.spec.ts:260:5
...
Call log:
  - waiting for locator('//span[text()=\'Communication\']')
    ...
    - navigated to "https://app.digipulsesp.in/home/"
...
```ts
  37  |   private submitButton:                Locator;
  38  |   private toastMessage:                Locator;
  39  |   private closeToastButton:            Locator;
  40  |   private categoryErrorSpan:           Locator;
  41  |   private customLinkErrorSpan:         Locator;
  42  |   private actionsMenuOptions:          Locator;
  43  | 
  44  |   // ─────────────────────────────────────────────────────────────────────
  45  |   // CONSTRUCTOR

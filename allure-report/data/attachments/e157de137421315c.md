...
- Name: social-autopost.spec.ts >> Social Auto Post >> TC_SAP_21 - Post PNG image 1600X698 with cobranding on Facebook
...
Call log:
  - waiting for locator('//div[contains(@class,\'btn-group\')]//a[@data-bs-toggle=\'dropdown\']') to be visible

...
- Name: push-notification.spec.ts >> TC_PN_08 - missing notification message shows validation message
- Location: tests\e2e\push-notification.spec.ts:173:5
...
Call log:
  - waiting for locator('xpath=(//a/span[text()=\'Create App Notification\'])[1]') to be visible
    99 × locator resolved to hidden <span class="m-2">Create App Notification</span>
